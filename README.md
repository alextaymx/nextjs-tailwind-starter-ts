# TypeScript Starter for Next JS 13, Tailwind CSS 3.3

<p align="center">
  <a href="https://github.com/alextaymx/nextjs-tailwind-starter-ts"><img src="./public/assets/images/nextjs-tailwind-starter-ts-banner.png" alt="Next js starter banner"></a>
</p>
...
Clone this project and use it to create your own [Next.js](https://nextjs.org) project. You can check a [Next js templates demo](https://github.com/alextaymx/nextjs-tailwind-starter-ts/).
...
```shell
git clone --depth=1 https://github.com/alextaymx/nextjs-tailwind-starter-ts.git my-project-name
cd my-project-name
npm install
```
...
Made with ♥ by [Alex Tay](https://github.com/alextaymx)
